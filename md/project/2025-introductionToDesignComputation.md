---
id: course_data_in_design
type: course
title: Data in Design I & II
status: active
version: 1.0

summary: >
    A comprehensive course covering computational design, spatial data,
    geometry, GIS, algorithms, AI, visualization, and software development
    through coding and data-driven design workflows.
...
ontology_class: Course

requires_data: []

produces:
    - computational_design_knowledge
    - geospatial_knowledge
    - software_projects
    - research_projects
...
- Data processing, Data Type, Memory, Python, Numpy, Pandas library, ...  
  As a first step, We will learn the basic concept of programming, dealing with logical flows and data manipulation.  
   _ LAB 01 - Python Basic, Condition & Loop, Primitive Data Structure  
   _ LAB 02 - File formats, Data Structure, object(class)  
   _ LAB 04 - Matrix, Numpy basic  
   _ LAB 05 - Pandas basic
...
- Vector & Point - https://namjulee.github.io/njs-lab-public/lab/lab-vector-&-point-discrete-design-data/vector
    ...
    - Coordinate System  
      ![Data in Design](https://raw.githubusercontent.com/NamjuLee/data/master/computation/Programming/coordinateSystem.png)  
       _ 1D, t value - Curve / R1 space projection  
       _ 2D, uv value - R2 space projection  
