import{gD as b,uA as T,En as Mt,Cj as H,Eo as Yt,Ep as Ee,Eq as fn,mg as A,Er as Yn,Es as J,ya as Zs,Et as Gt,Eu as mn,Ev as q,Ew as ye,Ex as Qt,Ey as zt,Ez as Js,EA as Qe,ms as X,EB as V,EC as Ze,ED as Ve,EE as pe,Bo as Ie,EF as eo,EG as to,EH as no,EI as so,EJ as oo,gF as Qn,gM as ro,yl as ao,xL as Ht,EK as Zn,EL as Jn,EM as io,EN as co,EO as lo,EP as uo,EQ as po,ER as ho,ES as fo,ET as mo,EU as xo,EV as xn,EW as go,EX as Co,EY as vo,EZ as vt,E_ as $o,E$ as je,F0 as K,w7 as bo,vs as wo,mj as xe,F1 as we,F2 as gn,F3 as Zt,F4 as Cn,F5 as Ro,F6 as It,F7 as So,jX as yo,F8 as Io,zX as To,F9 as Eo,Fa as No,Am as ko,w1 as Oo,vd as Fo,wb as Po,wT as Do,wE as Ao,x5 as _o,Fb as Lo,Fc as Bo,Fd as Jt,Fe as ie,Ff as ce,Fg as de,Fh as ve,B5 as en,xH as Vo,xQ as Uo,xX as Wo,uJ as Mo,uK as Go,uL as zo,uQ as Ho,uR as Xo,uS as Ko,uT as jo,uU as qo,uV as Yo,uW as Qo,uX as Zo,uY as Jo,uZ as er,u_ as tr,u$ as nr,Fi as st,Fj as ot,v0 as sr,Fk as Tt,v1 as or,v2 as rr,v3 as ar,vT as ir,xn as cr,Fl as lr,Fm as ur,v4 as dr,Fn as es,Fo as ts,Fp as ns,Fq as pr,Fr as hr,v5 as fr,v6 as mr,v7 as xr,wJ as gr,w$ as Cr,va as vr,gZ as $r,Fs as br,vb as wr,vc as Rr,ve as Sr,Ft as _e,w2 as yr,vf as Ir,Fu as Tr,vg as Er,Fv as Et,Fw as $e,vh as Nr,vi as kr,vj as Or,Fx as tn,vk as Fr,vl as Pr,vm as Dr,vn as Ar,vo as _r,Fy as ss,vp as Lr,vq as Br,vt as Vr,vu as Ur,vv as Wr,vw as Mr,vx as Gr,vy as zr,vz as Hr,Fz as Xr,vE as Kr,FA as jr,FB as qr,FC as Yr,FD as Qr,FE as Zr,vF as Jr,vG as ea,vI as ta,vJ as na,FF as sa,FG as oa,FH as ra,FI as aa,FJ as ia,FK as ca,vK as la,vL as ua,vM as da,vN as pa,vO as ha,FL as fa,vP as ma,vQ as xa,vR as ga,vS as Ca,vU as va,vV as $a,vX as ba,FM as wa,vY as Ra,FN as Sa,vZ as ya,v_ as Ia,w0 as Ta,w4 as Ea,w5 as Na,w6 as ka,wc as Oa,wd as Fa,we as Pa,wf as Da,wg as Aa,wi as _a,wj as La,wk as Ba,w8 as Va,w9 as Ua,wq as Wa,ww as Ma,wr as Ga,ws as za,wt as Ha,wu as Xa,wv as Ka,wx as ja,wy as qa,wz as Ya,wA as Qa,wB as Za,x0 as Ja,xG as ei,xo as ti,wD as ni,wF as si,wG as oi,FO as ri,wH as ai,FP as ii,wI as ci,FQ as li,wL as ui,xW as di,wM as pi,wP as hi,FR as fi,wQ as mi,wS as xi,wU as gi,wW as Ci,wX as vi,wY as $i,wZ as bi,x1 as wi,x3 as Ri,x4 as Si,x6 as yi,x7 as Ii,x8 as Ti,x9 as Ei,xa as Ni,xb as ki,FS as Oi,xc as Fi,xd as Pi,xf as Di,FT as nn,xg as Ai,xh as _i,xi as Li,FU as Bi,FV as Vi,xj as Ui,xk as Wi,xl as Mi,xm as Gi,xp as zi,xq as Hi,xr as Xi,xs as Ki,xt as ji,xu as qi,xv as Yi,xw as Qi,FW as Zi,xx as Ji,xy as ec,xz as tc,xA as nc,xB as sc,xC as oc,FX as rc,FY as ac,xD as ic,xE as cc,xF as lc,xJ as uc,xK as dc,xM as pc,xN as hc,xO as fc,xP as mc,xR as xc,xS as gc,xT as Cc,FZ as vc,F_ as $c,Ao as bc}from"./index-BpVWQNWp.js";/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function Au(n,e,t){const s=Ve(-1,t);return ms([],e,s,n,t)}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Xp(n,e,t,s){const o=e,r=n.shape.length,a=K(o,n.shape);let c=a;const i=ie(c,r),l=i!=null;let u=n;l&&(u=Ot(n,i,s),c=ce(c.length,r)),de("sum",c,r);const[d,p]=pe(u.shape,c);let h=d;t&&(h=ve(d,a));const f=T(p),x=T(n.shape)/f,m=R({inputs:{x:u},attrs:{shape:[x,f]},backend:s}),C=en(n.dtype),$=Fe(m,C,"sum",s),v=R({inputs:{x:$},attrs:{shape:h},backend:s});return s.disposeIntermediateTensorInfo(m),s.disposeIntermediateTensorInfo($),l&&s.disposeIntermediateTensorInfo(u),v}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Ts=1e3;function Rt({a:n,b:e,transposeA:t,transposeB:s,backend:o,bias:r=null,preluActivationWeights:a=null,leakyreluAlpha:c=0,activation:i=null}){const l=n.shape.length,u=e.shape.length,d=t?n.shape[l-2]:n.shape[l-1],p=s?e.shape[u-1]:e.shape[u-2],h=t?n.shape[l-1]:n.shape[l-2],f=s?e.shape[u-2]:e.shape[u-1],g=n.shape.slice(0,-2),x=e.shape.slice(0,-2),m=T(g),C=T(x),v=q(n.shape.slice(0,-2),e.shape.slice(0,-2)).concat([h,f]);A(d===p,()=>`Error in matMul: inner shapes (${d}) and (${p}) of Tensors with shapes ${n.shape} and ${e.shape} and transposeA=${t} and transposeB=${s} must match.`);const w=t?[m,d,h]:[m,h,d],N=s?[C,f,p]:[C,p,f],I=R({inputs:{x:n},backend:o,attrs:{shape:w}}),y=R({inputs:{x:e},backend:o,attrs:{shape:N}}),O=[I,y],k=Math.max(m,C),D=t?I.shape[1]:I.shape[2],_=r!=null,le=a!=null,j=i==="leakyrelu",Q=i!=null?et(i,!0):null,te=_||le||j||Q!=null;let re;if((h===1||f===1)&&D>Ts&&te===!1){let me=I,Pe=y;t&&(me=G({inputs:{x:I},backend:o,attrs:{perm:[0,2,1]}}),O.push(me)),s&&(Pe=G({inputs:{x:y},backend:o,attrs:{perm:[0,2,1]}}),O.push(Pe));const De=f!==1,ut=f===1;let Dt=me;De&&(Dt=R({inputs:{x:me},backend:o,attrs:{shape:[k,D,1]}}),O.push(Dt));const Qs=f===1?2:1;let At=Pe;ut&&(At=R({inputs:{x:Pe},backend:o,attrs:{shape:[k,1,D]}}),O.push(At));const hn=un({inputs:{a:Dt,b:At},backend:o});re=Ft({inputs:{x:hn},backend:o,attrs:{axis:Qs,keepDims:!0}}),O.push(hn)}else{const me=Ie(n.dtype,e.dtype),Pe=new Is(w,N,[k,h,f],t,s,_,Q,le,j),De=[I,y];if(r!=null&&De.push(r),le&&De.push(a),j){const ut=o.makeTensorInfo([],"float32",Ve(c,"float32"));De.push(ut),O.push(ut)}re=o.runWebGLProgram(Pe,De,me)}const W=R({inputs:{x:re},backend:o,attrs:{shape:v}});O.push(re);for(const me of O)o.disposeIntermediateTensorInfo(me);return W}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function uh(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:r,keepDims:a}=s,c=o.shape.length,i=K(r,o.shape);let l=i;const u=ie(l,c);let d=o;u!=null&&(d=G({inputs:{x:o},backend:t,attrs:{perm:u}}),l=ce(l.length,c)),de("all",l,c);const[p,h]=pe(d.shape,l),f=T(h),g=R({inputs:{x:d},backend:t,attrs:{shape:[-1,f]}}),x=Fe(g,g.dtype,"all",t);let m;if(a){const C=ve(p,i);m=R({inputs:{x},backend:t,attrs:{shape:C}})}else m=R({inputs:{x},backend:t,attrs:{shape:p}});return t.disposeIntermediateTensorInfo(g),t.disposeIntermediateTensorInfo(x),u!=null&&t.disposeIntermediateTensorInfo(d),m}const dh={kernelName:Ko,backendName:"webgl",kernelFunc:uh};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function ph(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:r,keepDims:a}=s,c=o.shape.length,i=K(r,o.shape);let l=i;const u=ie(l,c);let d=o;u!=null&&(d=G({inputs:{x:o},backend:t,attrs:{perm:u}}),l=ce(l.length,c)),de("any",l,c);const[p,h]=pe(d.shape,l),f=T(h),g=R({inputs:{x:d},backend:t,attrs:{shape:[-1,f]}}),x=Fe(g,g.dtype,"any",t);let m;if(a){const C=ve(p,i);m=R({inputs:{x},backend:t,attrs:{shape:C}})}else m=R({inputs:{x},backend:t,attrs:{shape:p}});return t.disposeIntermediateTensorInfo(g),t.disposeIntermediateTensorInfo(x),u!=null&&t.disposeIntermediateTensorInfo(d),m}const hh={kernelName:jo,backendName:"webgl",kernelFunc:ph};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function St(n,e){const t=n.length;return t>=3?e?[...n.slice(0,-3),n[t-3]*n[t-2],n[t-1]]:[...n.slice(0,-3),n[t-3],n[t-2]*n[t-1]]:!e&&t===1&&n[0]>1?[n[0],1]:null}function As({x:n,filter:e,convInfo:t,backend:s,bias:o=null,preluActivationWeights:r=null,leakyreluAlpha:a=0,activation:c=null}){const i=n.shape,l=s.texData.get(n.dataId),u=t.inChannels,d=i[0]*i[1]*i[2],p=t.outChannels,h=t.dataFormat==="channelsLast",f=!1,g=!1;let x;const m=[];if(r!=null){const v=St(r.shape,h);v!=null&&(r=R({inputs:{x:r},backend:s,attrs:{shape:v}}),m.push(r))}if(o!=null){const v=St(o.shape,h);v!=null&&(o=R({inputs:{x:o},backend:s,attrs:{shape:v}}),m.push(o))}if(!((d===1||p===1)&&u>Ts)&&l.isPacked&&h&&l.texture!=null&&i[2]%2!==0&&H(l.shape.slice(-3),i.slice(-3))){const v=i[0]*i[1]*(i[2]+1),w={dataId:n.dataId,shape:[1,v,t.inChannels],dtype:n.dtype},N=l.shape;l.shape=l.shape.slice(),l.shape[l.shape.length-2]++,A(bt(l.shape,w.shape),()=>`packed reshape ${l.shape} to ${w.shape} isn't free`);const I=R({inputs:{x:e},backend:s,attrs:{shape:[1,t.inChannels,t.outChannels]}});m.push(I);const y=Rt({a:w,b:I,backend:s,transposeA:f,transposeB:g,bias:o,activation:c,preluActivationWeights:r,leakyreluAlpha:a}),O=s.texData.get(y.dataId);A(O.isPacked,()=>"batchMatMul result is expected to be packed"),l.shape=N,O.shape=t.outShape,x=Y({inputs:{x:y},backend:s}),x.shape=t.outShape,m.push(y)}else{const v=t.outHeight*t.outWidth,w=R({inputs:{x:n},backend:s,attrs:{shape:h?[t.batchSize,v,t.inChannels]:[t.batchSize,t.inChannels,v]}}),N=R({inputs:{x:e},backend:s,attrs:{shape:[1,t.inChannels,t.outChannels]}}),I=Rt({a:h?w:N,b:h?N:w,transposeA:!h,transposeB:g,backend:s,bias:o,activation:c,preluActivationWeights:r,leakyreluAlpha:a});x=R({inputs:{x:I},backend:s,attrs:{shape:t.outShape}}),m.push(w),m.push(N),m.push(I)}for(const v of m)s.disposeIntermediateTensorInfo(v);return x}function _s({x:n,filter:e,convInfo:t,backend:s,bias:o=null,preluActivationWeights:r=null,leakyreluAlpha:a=0,activation:c=null}){const{filterWidth:i,filterHeight:l,inChannels:u,outWidth:d,outHeight:p,dataFormat:h}=t,f=h==="channelsLast",g=i*l*u,x=p*d,m=[t.batchSize,g,x],C=!0,$=!1,v=[];if(r!=null){const W=St(r.shape,f);W!=null&&(r=R({inputs:{x:r},backend:s,attrs:{shape:W}}),v.push(r))}if(o!=null){const W=St(o.shape,f);W!=null&&(o=R({inputs:{x:o},backend:s,attrs:{shape:W}}),v.push(o))}const w=R({inputs:{x:e},backend:s,attrs:{shape:[1,g,T(e.shape)/g]}});v.push(w);const N=new Af(m,t),I=[n.shape,[t.padInfo.top,t.padInfo.left],[t.strideHeight,t.strideWidth],[t.dilationHeight,t.dilationWidth],[t.inChannels],[t.filterWidth*t.inChannels],[t.outWidth]],y=s.runWebGLProgram(N,[n],"float32",I),O=R({inputs:{x:y},backend:s,attrs:{shape:m}});v.push(y),v.push(O);const k=o!=null,D=r!=null,_=c==="leakyrelu",le=c?et(c,!0):null,j=new Is(f?O.shape:w.shape,f?w.shape:O.shape,f?[t.batchSize,x,t.outChannels]:[t.batchSize,t.outChannels,x],C,$,k,le,D,_),Q=f?[O,w]:[w,O];if(o&&Q.push(o),D&&Q.push(r),_){const W=s.makeTensorInfo([],"float32",Ve(a,"float32"));Q.push(W),v.push(W)}const te=s.runWebGLProgram(j,Q,"float32"),re=R({inputs:{x:te},backend:s,attrs:{shape:t.outShape}});v.push(te);for(const W of v)s.disposeIntermediateTensorInfo(W);return re}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,em=`
  ...
  ${Oe}
  return result;
`,tm=F({opSnippet:Jf,packedOpSnippet:em}),nm={kernelName:Dr,backendName:"webgl",kernelFunc:tm};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,om=F({opSnippet:sm}),rm={kernelName:Ar,backendName:"webgl",kernelFunc:om};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Dm="return (x >= 0.0) ? x : (exp(x) - 1.0);",Am=`
  vec4 result;
  ...
  return result;
`,_m=F({opSnippet:Dm,packedOpSnippet:Am}),Lm={kernelName:Jr,backendName:"webgl",kernelFunc:_m};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,Km=F({opSnippet:Xm}),jm={kernelName:na,backendName:"webgl",kernelFunc:Km};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,Ym=`
  ...
  return result;
`,Us=F({opSnippet:qm,packedOpSnippet:Ym,cpuKernelImpl:wd,dtype:"float32"}),Qm={kernelName:la,backendName:"webgl",kernelFunc:Us};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function qt(n){const{inputs:e,attrs:t,backend:s}=n,{dim:o}=t,{input:r}=e,a=r.shape.length,c=r.shape.slice();let i=o;return o<0&&(A(-(a+1)<=o,()=>`Axis must be in the interval [${-(a+1)}, ${a}]`),i=a+o+1),c.splice(i,0,1),R({inputs:{x:r},backend:s,attrs:{shape:c}})}const Zm={kernelName:ua,backendName:"webgl",kernelFunc:qt};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Gn="return exp(x) - 1.0;",Jm=F({opSnippet:Gn,packedOpSnippet:Gn,cpuKernelImpl:Rd}),ex={kernelName:da,backendName:"webgl",kernelFunc:Jm};/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Hn="return floor(x);",ix=F({opSnippet:Hn,packedOpSnippet:Hn,cpuKernelImpl:Sd}),cx={kernelName:xa,backendName:"webgl",kernelFunc:ix};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const mx={kernelName:Ca,backendName:"webgl",kernelFunc:xx};let Ae,Wt=b().getBool("CANVAS2D_WILL_READ_FREQUENTLY_FOR_GPU");function xx(n){const{inputs:e,backend:t,attrs:s}=n;let{pixels:o}=e;const{numChannels:r}=s,a=typeof HTMLVideoElement<"u"&&o instanceof HTMLVideoElement,c=typeof HTMLImageElement<"u"&&o instanceof HTMLImageElement,[i,l]=a?[o.videoWidth,o.videoHeight]:[o.width,o.height],u=[l,i],d=[l,i,r];if(c||a){const g=b().getBool("CANVAS2D_WILL_READ_FREQUENTLY_FOR_GPU");(Ae==null||g!==Wt)&&(Wt=g,Ae=document.createElement("canvas").getContext("2d",{willReadFrequently:Wt})),Ae.canvas.width=i,Ae.canvas.height=l,Ae.drawImage(o,0,0,i,l),o=Ae.canvas}const p=t.makeTensorInfo(u,"int32");t.texData.get(p.dataId).usage=Z.PIXELS,t.gpgpu.uploadPixelDataToTexture(t.getTexture(p.dataId),o);const h=b().getBool("WEBGL_PACK")?new fx(d):new hx(d),f=t.runWebGLProgram(h,[p],"int32");return t.disposeData(p.dataId),f}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function gx(n){const{inputs:e,backend:t,attrs:s}=n,{x:o,filter:r,bias:a,preluActivationWeights:c}=e,{strides:i,pad:l,dataFormat:u,dilations:d,dimRoundingMode:p,activation:h,leakyreluAlpha:f}=s,g=Et(u),x=$e(o.shape,r.shape,i,d,l,p,!1,g);let m;const C=[],$=a!=null,v=c!=null,w=h==="leakyrelu",N=()=>{const y=[o,r],O=(k,D)=>{if(D==="NCHW"&&k.shape.length===1&&k.shape[0]!==1){const _=R({inputs:{x:k},backend:t,attrs:{shape:[k.shape[0],1,1]}});return C.push(_),_}return k};if($&&y.push(O(a,u)),v&&y.push(O(c,u)),w){const k=t.makeTensorInfo([],"float32",Ve(f,"float32"));y.push(k),C.push(k)}return y};if(x.filterHeight===1&&x.filterWidth===1&&x.dilationHeight===1&&x.dilationWidth===1&&x.strideHeight===1&&x.strideWidth===1&&(x.padInfo.type==="SAME"||x.padInfo.type==="VALID"))m=As({x:o,filter:r,convInfo:x,backend:t,bias:a,activation:h,preluActivationWeights:c,leakyreluAlpha:f});else if(x.strideWidth<=2&&g==="channelsLast"&&b().getBool("WEBGL_EXP_CONV")){const y=h?et(h,!0):null,O=new Ds(x,$,y,v,w),k=[[x.padInfo.top,x.padInfo.left],[x.strideHeight,x.strideWidth],[x.dilationHeight,x.dilationWidth],[x.inHeight,x.inWidth]],D=N();m=t.runWebGLProgram(O,D,"float32",k)}else if(b().getBool("WEBGL_CONV_IM2COL"))m=_s({x:o,filter:r,convInfo:x,backend:t,bias:a,activation:h,preluActivationWeights:c,leakyreluAlpha:f});else{const y=h?et(h,!1):null,O=new Ps(x,$,y,v,w),k=N();m=t.runWebGLProgram(O,k,"float32")}const I=R({inputs:{x:m},backend:t,attrs:{shape:x.outShape}});return C.push(m),C.forEach(y=>t.disposeIntermediateTensorInfo(y)),I}const Cx={kernelName:va,backendName:"webgl",kernelFunc:gx};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Ox="return float(a >= b);",Fx=`
  return vec4(greaterThanEqual(a, b));
`,Px=B({opSnippet:Ox,packedOpSnippet:Fx,dtype:"bool",cpuKernelImpl:Ed}),Dx={kernelName:Ia,backendName:"webgl",kernelFunc:Px};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ax(n){const{inputs:e,backend:t}=n,{input:s}=e;return Ws(s,!0,t)}const _x={kernelName:Ta,backendName:"webgl",kernelFunc:Ax};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Lx="return float(!isnan(x) && !isinf(x));",Bx=F({opSnippet:Lx,dtype:"bool"}),Vx={kernelName:Ea,backendName:"webgl",kernelFunc:Bx};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Ux="return float(isinf(x));",Wx=F({opSnippet:Ux,dtype:"bool"}),Mx={kernelName:Na,backendName:"webgl",kernelFunc:Wx};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Gx="return float(isnan(x));",zx=F({opSnippet:Gx,dtype:"bool"}),Hx={kernelName:ka,backendName:"webgl",kernelFunc:zx};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,Zx=B({opSnippet:Yx,packedOpSnippet:Qx,cpuKernelImpl:kd,dtype:"bool"}),Jx={kernelName:Fa,backendName:"webgl",kernelFunc:Zx};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const hg="return float(!(x >= 1.0));",fg=F({opSnippet:hg}),mg={kernelName:La,backendName:"webgl",kernelFunc:fg};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Kg(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:r,keepDims:a}=s,c=o.shape.length,i=K(r,o.shape);let l=i;const u=ie(l,c);let d=o;u!=null&&(d=G({inputs:{x:o},backend:t,attrs:{perm:u}}),l=ce(l.length,o.shape.length)),de("min",l,c);const[p,h]=pe(d.shape,l),f=T(h),g=R({inputs:{x:d},backend:t,attrs:{shape:[-1,f]}}),x=Fe(g,g.dtype,"min",t);let m;if(a){const C=ve(p,i);m=R({inputs:{x},backend:t,attrs:{shape:C}})}else m=R({inputs:{x},backend:t,attrs:{shape:p}});return t.disposeIntermediateTensorInfo(g),t.disposeIntermediateTensorInfo(x),u!=null&&t.disposeIntermediateTensorInfo(d),m}const jg={kernelName:qa,backendName:"webgl",kernelFunc:Kg};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function p$(n){const{inputs:e,backend:t,attrs:s}=n,{x:o,segmentIds:r}=e,{numSegments:a}=s,c=o.shape.length,i=[];let l=0;const u=ie([l],c);let d=o;u!=null&&(d=G({inputs:{x:o},backend:t,attrs:{perm:u}}),i.push(d),l=ce(1,c)[0]);const p=vc(d.shape,l,a),h=T([d.shape[l]]),f=R({inputs:{x:d},backend:t,attrs:{shape:[-1,h]}});i.push(f);const g=en(o.dtype),x=(v,w,N,I,y)=>{const O=v.shape[0],k=v.shape[1],D=$c(k,y),_={windowSize:D,inSize:k,batchSize:O,numSegments:y},le=new d$(_,w),j=t.compileAndRun(le,[v,N],I);if(i.push(j),j.shape[1]===y)return j;const Q=qs({backend:t,attrs:{start:0,stop:y,step:1,dtype:"float32"}}),te=Ys({inputs:{x:Q},backend:t,attrs:{reps:[k/D]}});return i.push(Q),i.push(te),x(j,w,te,I,y)},m=x(f,"unsortedSegmentSum",r,g,a),C=R({inputs:{x:m},backend:t,attrs:{shape:p}});let $=C;if(u!=null){i.push(C);const v=ss(u);$=G({inputs:{x:$},backend:t,attrs:{perm:v}})}return i.forEach(v=>t.disposeIntermediateTensorInfo(v)),$}const h$={kernelName:Cc,backendName:"webgl",kernelFunc:p$};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const f$=[Yp,Zp,th,oh,ah,lh,dh,hh,gh,vh,wh,yh,Eh,Fh,Ah,Lh,Vh,Gh,Hh,Kh,Qh,of,af,df,hf,vf,bf,yf,Pp,Ef,Pf,Lf,Gf,Xf,jf,Yf,Zf,nm,rm,cm,um,pm,fm,gm,vm,Rm,ym,Em,Om,Pm,Lm,Wm,Hm,jm,Qm,Zm,ex,nx,ox,ax,cx,px,mx,Cx,$x,Rx,Ix,kx,Dx,Fp,_x,Of,Vx,Mx,Hx,Ap,qx,Jx,tg,rg,cg,pg,mg,vg,Rg,Ig,Eg,Fg,Dg,_g,Ug,Mg,zg,Xg,jg,Zg,nC,aC,fC,Bp,CC,bC,SC,TC,mf,kC,FC,DC,LC,WC,Lp,GC,HC,KC,qC,YC,xf,uC,JC,s0,i0,Up,d0,f0,C0,b0,y0,T0,k0,P0,_0,V0,M0,H0,q0,Z0,nv,rv,nf,pC,cv,uv,pv,fv,xv,Cv,$v,wv,Sv,Tv,Nv,Ov,Pv,_v,Bv,Uv,Mv,dC,Kp,Hv,jv,Yv,Jv,s$,a$,jp,c$,u$,h$,OC];for(const n of f$)bc(n);
