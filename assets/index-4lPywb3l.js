import{gF as x,gK as ct,gR as ne,gQ as ft,g_ as V,mi as nt,g$ as z,gT as It,mj as ut,gY as Pt,gE as Ft,mk as re,gL as pt,ml as ae,j_ as Q,mm as At,mn as Lt,mo as Nt,gM as rt,gG as se,gH as oe,mp as ie,mq as de,mr as Dt,ms as ue,jY as le,gO as _t}from"./index-BhdSrBGh.js";import{g as ce}from"./index-C0vqmb3-.js";import{R as fe}from"./RendererCanvas-ZMRkw2u7.js";import"./register_all_kernels-D0PlBSe9.js";import{l as Wt}from"./graph_model-D_Qhf-ep.js";/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function Se(t,n,e){e===void 0&&(e=.3);for(var r=0,s=0,a=0;a<t.length;a++)n.keypoints[a].score>e&&(s+=1,r+=Math.pow(t[a].x-n.keypoints[a].position.x,2)+Math.pow(t[a].y-n.keypoints[a].position.y,2));return s===0?r=1/0:r=r/s,r}function be(t,n,e,r){var s=n[0],a=n[1],i=e[0],d=e[1],u=Math.round(((s+t.y+1)*d-1)/r),o=Math.round(((a+t.x+1)*i-1)/r);return{x:o,y:u}}function Ee(t,n,e,r,s,a,i){for(var d=i[0],u=i[1],o=e(t),l=o.y*r+o.x,c=s[H*(2*l)+n],f=s[H*(2*l+1)+n],p=t.y+c,h=t.x+f,m=0;m<a;m++){p=Math.min(p,d-1),h=Math.min(h,u-1);var w=e({x:h,y:p}),S=w.y*r+w.x;c=s[H*(2*S)+n],f=s[H*(2*S+1)+n],p=p+c,h=h+f}return{x:h,y:p}}function Kt(t,n,e,r,s,a,i,d,u,o){for(var l=s[0],c=s[1],f=a[0],p=a[1],h=d[0],m=d[1],w=[],S=function(M){return be(M,[l,c],[f,p],u)},g=0;g<r;g++){var b=Ee(t,g,S,i,n,o,[h,m]);w.push(b)}for(var v=-1,y=1/0,E=0;E<e.length;E++){var R=Se(w,e[E]);R<y&&(v=E,y=R)}return v}function Ut(t,n){var e=t[0],r=t[1],s=Math.round((r-1)/n+1),a=Math.round((e-1)/n+1);return[s,a]}function Re(t,n,e,r,s,a,i,d,u,o){var l=i[0],c=i[1];o===void 0&&(o=5);for(var f=e.map(function(M){return new Uint8Array(r*s).fill(0)}),p=d.top,h=d.left,m=ht([r,s],[l,c],d),w=m[0],S=m[1],g=Ut([l,c],a)[0],b=0;b<r;b+=1)for(var v=0;v<s;v+=1){var y=b*s+v,E=t[y];if(E===1){var R=Kt({x:v,y:b},n,e,o,[p,h],[w,S],g,[r,s],a,u);R>=0&&(f[R][y]=1)}}return f}function Me(t,n,e,r,s,a,i,d,u,o,l){var c=d[0],f=d[1];l===void 0&&(l=5);for(var p=r.map(function(B){return new Int32Array(s*a).fill(-1)}),h=u.top,m=u.left,w=ht([s,a],[c,f],u),S=w[0],g=w[1],b=Ut([c,f],i)[0],v=0;v<s;v+=1)for(var y=0;y<a;y+=1){var E=v*a+y,R=t[E];if(R===1){var M=Kt({x:y,y:v},n,r,l,[h,m],[S,g],b,[s,a],i,o);M>=0&&(p[M][E]=e[E])}}return p}/**
 * @license
 * Copyright 2019 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Qt(t,n,e,r,s,a,i,d,u,o,l){for(var c=i[0],f=i[1],p=t.shape,h=p[0],m=p[1],w=n.shape.slice(0,2),S=w[0],g=w[1],b=rt(n,[S,g,2,H]),v=new Float32Array(l*H*3).fill(0),y=0;y<e.length;y++)for(var E=y*H*3,R=e[y],M=0;M<H;M++){var B=R.keypoints[M],T=E+M*3;v[T]=B.score,v[T+1]=B.position.y,v[T+2]=B.position.x}var O=ht([r,s],[c,f],d),A=O[0],L=O[1],N=ie(v,[l,H,3]),D=d.top,_=d.left,q={variableNames:["segmentation","longOffsets","poses"],outputShape:[h,m],userCode:`
 ...
 * limitations under the License.
 * =============================================================================
 */function Te(t,n){return x(function(){return V(Dt(t,Q(n)),"int32")})}function Be(t,n,e){return x(function(){return ct(_t(V(Dt(t,Q(e)),"int32"),ft(n,1)),1)})}function Gt(){return oe()==="webgl"}function Oe(t,n,e,r,s,a,i,d,u,o,l,c){var f=i[0],p=i[1];return u===void 0&&(u=.2),o===void 0&&(o=8),l===void 0&&(l=.3),c===void 0&&(c=10),P(this,void 0,void 0,function(){var h,m,w,S,g;return F(this,function(b){switch(b.label){case 0:return h=e.filter(function(v){return v.score>=u}),Gt()?(w=x(function(){var v=Qt(t,n,h,r,s,a,[f,p],d,o,l,c),y=At().makeTensorFromDataId(v.dataId,v.shape,v.dtype);return h.map(function(E,R){return Te(y,R)})}),[4,Promise.all(w.map(function(v){return v.data()}))]):[3,2];case 1:return m=b.sent(),w.forEach(function(v){return v.dispose()}),[3,5];case 2:return[4,t.data()];case 3:return S=b.sent(),[4,n.data()];case 4:g=b.sent(),m=Re(S,g,h,r,s,a,[f,p],d,o),b.label=5;case 5:return[2,m.map(function(v,y){return{data:v,pose:h[y],width:s,height:r}})]}})})}function xe(t,n,e,r,s,a,i,d,u,o,l,c,f){var p=d[0],h=d[1];return o===void 0&&(o=.2),l===void 0&&(l=8),c===void 0&&(c=.3),f===void 0&&(f=10),P(this,void 0,void 0,function(){var m,w,S,g,b,v;return F(this,function(y){switch(y.label){case 0:return m=r.filter(function(E){return E.score>=o}),Gt()?(S=x(function(){var E=Qt(t,n,m,s,a,i,[p,h],u,l,c,f),R=At().makeTensorFromDataId(E.dataId,E.shape,E.dtype);return m.map(function(M,B){return Be(R,e,B)})}),[4,Promise.all(S.map(function(E){return E.data()}))]):[3,2];case 1:return w=y.sent(),S.forEach(function(E){return E.dispose()}),[3,6];case 2:return[4,t.data()];case 3:return g=y.sent(),[4,n.data()];case 4:return b=y.sent(),[4,e.data()];case 5:v=y.sent(),w=Me(g,b,v,m,s,a,i,[p,h],u,l),y.label=6;case 6:return[2,w.map(function(E,R){return{pose:m[R],data:E,height:s,width:a}})]}})})}/**
 * @license
 * Copyright 2019 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ie(t,n,e,r,s,a){for(var i=a.shape,d=i[0],u=i[1],o=!0,l=Math.max(e-s,0),c=Math.min(e+s+1,d),f=l;f<c;++f){for(var p=Math.max(r-s,0),h=Math.min(r+s+1,u),m=p;m<h;++m)if(a.get(f,m,t)>n){o=!1;break}if(!o)break}return o}function Pe(t,n,e){for(var r=e.shape,s=r[0],a=r[1],i=r[2],d=new He(s*a*i,function(f){var p=f.score;return p}),u=0;u<s;++u)for(var o=0;o<a;++o)for(var l=0;l<i;++l){var c=e.get(u,o,l);c<t||Ie(l,c,u,o,n,e)&&d.enqueue({score:c,part:{heatmapY:u,heatmapX:o,id:l}})}return d}/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */var Yt=we.map(function(t){var n=t[0],e=t[1];return[et[n],et[e]]}),it=Yt.map(function(t){var n=t[1];return n}),gt=Yt.map(function(t){var n=t[0];return n});function Fe(t,n,e){var r=e.shape[2]/2;return{y:e.get(n.y,n.x,t),x:e.get(n.y,n.x,r+t)}}function dt(t,n,e,r){return{y:mt(Math.round(t.y/n),0,e-1),x:mt(Math.round(t.x/n),0,r-1)}}function wt(t,n,e,r,s,a,i,d){d===void 0&&(d=2);for(var u=r.shape,o=u[0],l=u[1],c=dt(n.position,a,o,l),f=Fe(t,c,i),p=vt(n.position,f),h=p,m=0;m<d;m++){var w=dt(h,a,o,l),S=Vt(w.y,w.x,e,s);h=vt({x:w.x*a,y:w.y*a},{x:S.x,y:S.y})}var g=dt(h,a,o,l),b=r.get(g.y,g.x,e);return{position:h,part:at[e],score:b}}function Ae(t,n,e,r,s,a){var i=n.shape[2],d=it.length,u=new Array(i),o=t.part,l=t.score,c=qt(o,r,e);u[o.id]={score:l,part:at[o.id],position:c};for(var f=d-1;f>=0;--f){var p=it[f],h=gt[f];u[p]&&!u[h]&&(u[h]=wt(f,u[p],h,n,e,r,a))}for(var f=0;f<d;++f){var p=gt[f],h=it[f];u[p]&&!u[h]&&(u[h]=wt(f,u[p],h,n,e,r,s))}return u}/**
 * @license
 * Copyright 2019 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function jt(t,n,e,r){var s=e.x,a=e.y;return t.some(function(i){var d=i.keypoints,u=d[r].position;return ye(a,s,u.y,u.x)<=n})}function Le(t,n,e){var r=e.reduce(function(s,a,i){var d=a.position,u=a.score;return jt(t,n,d,i)||(s+=u),s},0);return r/=e.length}var Ne=1;function Y(t,n,e,r,s,a,i,d){i===void 0&&(i=.5),d===void 0&&(d=20);for(var u=[],o=Pe(i,Ne,t),l=d*d;u.length<a&&!o.empty();){var c=o.dequeue(),f=qt(c.part,s,n);if(!jt(u,l,f,c.part.id)){var p=Ae(c,t,n,s,e,r),h=Le(u,l,p);u.push({keypoints:p,score:h})}}return u}/**
 * @license
 * Copyright 2019 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 *
 * =============================================================================
 */var k;function Ce(t){if("offsetHeight"in t&&t.offsetHeight!==0&&"offsetWidth"in t&&t.offsetWidth!==0)return[t.offsetHeight,t.offsetWidth];if(t.height!=null&&t.width!=null)return[t.height,t.width];throw new Error("HTMLImageElement must have height and width attributes set.")}function ze(t){return t.hasAttribute("height")&&t.hasAttribute("width")?[t.height,t.width]:[t.videoHeight,t.videoWidth]}function K(t){if(typeof HTMLCanvasElement<"u"&&t instanceof HTMLCanvasElement||typeof OffscreenCanvas<"u"&&t instanceof OffscreenCanvas||typeof HTMLImageElement<"u"&&t instanceof HTMLImageElement)return Ce(t);if(typeof ImageData<"u"&&t instanceof ImageData)return[t.height,t.width];if(typeof HTMLVideoElement<"u"&&t instanceof HTMLVideoElement)return ze(t);if(t instanceof Ft)return[t.shape[0],t.shape[1]];throw new Error("error: Unknown input type: ".concat(t,"."))}function Ve(t,n){return(t-1)%n===0}function bt(t,n){return Ve(t,n)?t:Math.floor(t/n)*n+1}var U={low:"low",medium:"medium",high:"high",full:"full"},qe=(k={},k[U.low]=.25,k[U.medium]=.5,k[U.high]=.75,k[U.full]=1,k),Et=.1,Rt=2;function Ke(t){if(typeof t=="string"){var n=qe[t];return ut(typeof n=="number",function(){return"string value of inputResolution must be one of ".concat(Object.values(U).join(",")," but was ").concat(t,".")}),n}else return ut(typeof t=="number"&&t<=Rt&&t>=Et,function(){return"inputResolution must be a string or number between ".concat(Et," and ").concat(Rt,", but ")+"was ".concat(t)}),t}function j(t,n,e){var r=e[0],s=e[1],a=Ke(t);return[bt(r*a,n),bt(s*a,n)]}function Ue(t){return t instanceof Ft?t:se(t)}function C(t,n,e,r,s){var a=n[0],i=n[1],d=e[0],u=e[1],o=r[0],l=o[0],c=o[1],f=r[1],p=f[0],h=f[1];return x(function(){var m=pt.resizeBilinear(t,[d,u],!0);return m=It(m),Qe(m,[a,i],[[l,c],[p,h]])})}function Qe(t,n,e){var r=n[0],s=n[1],a=e[0],i=a[0],d=a[1],u=e[1],o=u[0],l=u[1];return x(function(){var c=nt(t);return z(pt.cropAndResize(c,[[i/(r+i+d-1),o/(s+o+l-1),(i+r-1)/(r+i+d-1),(o+s-1)/(s+o+l-1)]],[0],[r,s]),[0])})}function X(t,n){var e=n[0],r=n[1],s=K(t),a=s[0],i=s[1],d=r/e,u=i/a,o=[0,0,0,0],l=o[0],c=o[1],f=o[2],p=o[3];u<d?(l=0,c=0,f=Math.round(.5*(d*a-i)),p=Math.round(.5*(d*a-i))):(l=Math.round(.5*(1/d*i-a)),c=Math.round(.5*(1/d*i-a)),f=0,p=0);var h=x(function(){var m=Ue(t);return m=re(m,[[l,c],[f,p],[0,0]]),pt.resizeBilinear(m,[e,r])});return{resized:h,padding:{top:l,left:f,right:p,bottom:c}}}function J(t){return P(this,void 0,void 0,function(){return F(this,function(n){return[2,Promise.all(t.map(function(e){return e.buffer()}))]})})}function Ge(t,n,e,r,s){return r===void 0&&(r=0),s===void 0&&(s=0),{score:t.score,keypoints:t.keypoints.map(function(a){var i=a.score,d=a.part,u=a.position;return{score:i,part:d,position:{x:u.x*e+s,y:u.y*n+r}}})}}function Ye(t,n,e,r,s){return r===void 0&&(r=0),s===void 0&&(s=0),e===1&&n===1&&r===0&&s===0?t:t.map(function(a){return Ge(a,n,e,r,s)})}function Z(t,n,e,r,s){var a=n[0],i=n[1],d=e[0],u=e[1],o=(a+r.top+r.bottom)/d,l=(i+r.left+r.right)/u,c=Ye(t,o,l,-r.top,-r.left);return c}var Xt={architecture:"MobileNetV1",outputStride:16,quantBytes:4,multiplier:.75},Mt=["MobileNetV1","ResNet50"],Tt={MobileNetV1:[8,16,32],ResNet50:[32,16]},Bt={MobileNetV1:[.5,.75,1],ResNet50:[1]},Ot=[1,2,4];function je(t){if(t=t||Xt,t.architecture==null&&(t.architecture="MobileNetV1"),Mt.indexOf(t.architecture)<0)throw new Error("Invalid architecture ".concat(t.architecture,". ")+"Should be one of ".concat(Mt));if(t.outputStride==null&&(t.outputStride=16),Tt[t.architecture].indexOf(t.outputStride)<0)throw new Error("Invalid outputStride ".concat(t.outputStride,". ")+"Should be one of ".concat(Tt[t.architecture]," ")+"for architecture ".concat(t.architecture,"."));if(t.multiplier==null&&(t.multiplier=1),Bt[t.architecture].indexOf(t.multiplier)<0)throw new Error("Invalid multiplier ".concat(t.multiplier,". ")+"Should be one of ".concat(Bt[t.architecture]," ")+"for architecture ".concat(t.architecture,"."));if(t.quantBytes==null&&(t.quantBytes=4),Ot.indexOf(t.quantBytes)<0)throw new Error("Invalid quantBytes ".concat(t.quantBytes,". ")+"Should be one of ".concat(Ot," ")+"for architecture ".concat(t.architecture,"."));return t}var $={flipHorizontal:!1,internalResolution:"medium",segmentationThreshold:.7,maxDetections:10,scoreThreshold:.4,nmsRadius:20},tt={flipHorizontal:!1,internalResolution:"medium",segmentationThreshold:.7,maxDetections:10,scoreThreshold:.4,nmsRadius:20,minKeypointScore:.3,refineSteps:10};function xt(t){var n=t.segmentationThreshold,e=t.maxDetections,r=t.scoreThreshold,s=t.nmsRadius;if(n<0||n>1)throw new Error("segmentationThreshold ".concat(n,". ")+"Should be in range [0.0, 1.0]");if(e<=0)throw new Error("Invalid maxDetections ".concat(e,". ")+"Should be > 0");if(r<0||r>1)throw new Error("Invalid scoreThreshold ".concat(r,". ")+"Should be in range [0.0, 1.0]");if(s<=0)throw new Error("Invalid nmsRadius ".concat(s,"."))}function Ht(t){var n=t.segmentationThreshold,e=t.maxDetections,r=t.scoreThreshold,s=t.nmsRadius,a=t.minKeypointScore,i=t.refineSteps;if(n<0||n>1)throw new Error("segmentationThreshold ".concat(n,". ")+"Should be in range [0.0, 1.0]");if(e<=0)throw new Error("Invalid maxDetections ".concat(e,". ")+"Should be > 0");if(r<0||r>1)throw new Error("Invalid scoreThreshold ".concat(r,". ")+"Should be in range [0.0, 1.0]");if(s<=0)throw new Error("Invalid nmsRadius ".concat(s,"."));if(a<0||a>1)throw new Error("Invalid minKeypointScore ".concat(a,".")+"Should be in range [0.0, 1.0]");if(i<=0||i>20)throw new Error("Invalid refineSteps ".concat(i,".")+"Should be in range [1, 20]")}var Jt=(function(){function t(n){this.baseModel=n}return t.prototype.predictForPersonSegmentation=function(n){var e=this.baseModel.predict(n),r=e.segmentation,s=e.heatmapScores,a=e.offsets,i=e.displacementFwd,d=e.displacementBwd;return{segmentLogits:r,heatmapScores:s,offsets:a,displacementFwd:i,displacementBwd:d}},t.prototype.predictForPersonSegmentationAndPart=function(n){var e=this.baseModel.predict(n),r=e.segmentation,s=e.partHeatmaps,a=e.heatmapScores,i=e.offsets,d=e.displacementFwd,u=e.displacementBwd;return{segmentLogits:r,partHeatmapLogits:s,heatmapScores:a,offsets:i,displacementFwd:d,displacementBwd:u}},t.prototype.predictForMultiPersonInstanceSegmentationAndPart=function(n){var e=this.baseModel.predict(n),r=e.segmentation,s=e.longOffsets,a=e.heatmapScores,i=e.offsets,d=e.displacementFwd,u=e.displacementBwd,o=e.partHeatmaps;return{segmentLogits:r,longOffsets:s,heatmapScores:a,offsets:i,displacementFwd:d,displacementBwd:u,partHeatmaps:o}},t.prototype.segmentPersonActivation=function(n,e,r){var s=this;r===void 0&&(r=.5);var a=K(n),i=a[0],d=a[1],u=j(e,this.baseModel.outputStride,[i,d]),o=X(n,u),l=o.resized,c=o.padding,f=x(function(){var g=s.predictForPersonSegmentation(l),b=g.segmentLogits,v=g.heatmapScores,y=g.offsets,E=g.displacementFwd,R=g.displacementBwd,M=l.shape,B=M[0],T=M[1],O=C(b,[i,d],[B,T],[[c.top,c.bottom],[c.left,c.right]]);return{segmentation:G(z(O),r),heatmapScores:v,offsets:y,displacementFwd:E,displacementBwd:R}}),p=f.segmentation,h=f.heatmapScores,m=f.offsets,w=f.displacementFwd,S=f.displacementBwd;return l.dispose(),{segmentation:p,heatmapScores:h,offsets:m,displacementFwd:w,displacementBwd:S,padding:c,internalResolutionHeightAndWidth:u}},t.prototype.segmentPerson=function(n,e){return e===void 0&&(e=$),P(this,void 0,void 0,function(){var r,s,a,i,d,u,o,l,c,f,p,h,m,w,S,g,b,v;return F(this,function(y){switch(y.label){case 0:return e=I(I({},$),e),xt(e),r=this.segmentPersonActivation(n,e.internalResolution,e.segmentationThreshold),s=r.segmentation,a=r.heatmapScores,i=r.offsets,d=r.displacementFwd,u=r.displacementBwd,o=r.padding,l=r.internalResolutionHeightAndWidth,c=s.shape,f=c[0],p=c[1],[4,s.data()];case 1:return h=y.sent(),s.dispose(),[4,J([a,i,d,u])];case 2:return m=y.sent(),w=m[0],S=m[1],g=m[2],b=m[3],v=Y(w,S,g,b,this.baseModel.outputStride,e.maxDetections,e.scoreThreshold,e.nmsRadius),v=Z(v,[f,p],l,o),a.dispose(),i.dispose(),d.dispose(),u.dispose(),[2,{height:f,width:p,data:h,allPoses:v}]}})})},t.prototype.segmentMultiPerson=function(n,e){return e===void 0&&(e=tt),P(this,void 0,void 0,function(){var r,s,a,i,d,u,o,l,c,f,p,h,m,w,S,g,b,v,y,E,R,M=this;return F(this,function(B){switch(B.label){case 0:return e=I(I({},tt),e),Ht(e),r=K(n),s=r[0],a=r[1],i=j(e.internalResolution,this.baseModel.outputStride,[s,a]),d=X(n,i),u=d.resized,o=d.padding,l=x(function(){var T=M.predictForMultiPersonInstanceSegmentationAndPart(u),O=T.segmentLogits,A=T.longOffsets,L=T.heatmapScores,N=T.offsets,D=T.displacementFwd,_=T.displacementBwd,q=C(O,[s,a],i,[[o.top,o.bottom],[o.left,o.right]]),W;W=A;var st=G(z(q),e.segmentationThreshold);return{segmentation:st,longOffsets:W,heatmapScoresRaw:L,offsetsRaw:N,displacementFwdRaw:D,displacementBwdRaw:_}}),c=l.segmentation,f=l.longOffsets,p=l.heatmapScoresRaw,h=l.offsetsRaw,m=l.displacementFwdRaw,w=l.displacementBwdRaw,[4,J([p,h,m,w])];case 1:return S=B.sent(),g=S[0],b=S[1],v=S[2],y=S[3],E=Y(g,b,v,y,this.baseModel.outputStride,e.maxDetections,e.scoreThreshold,e.nmsRadius),E=Z(E,[s,a],i,o),[4,Oe(c,f,E,s,a,this.baseModel.outputStride,i,o,e.scoreThreshold,e.refineSteps,e.minKeypointScore,e.maxDetections)];case 2:return R=B.sent(),u.dispose(),c.dispose(),f.dispose(),p.dispose(),h.dispose(),m.dispose(),w.dispose(),[2,R]}})})},t.prototype.segmentPersonPartsActivation=function(n,e,r){var s=this;r===void 0&&(r=.5);var a=K(n),i=a[0],d=a[1],u=j(e,this.baseModel.outputStride,[i,d]),o=X(n,u),l=o.resized,c=o.padding,f=x(function(){var g=s.predictForPersonSegmentationAndPart(l),b=g.segmentLogits,v=g.partHeatmapLogits,y=g.heatmapScores,E=g.offsets,R=g.displacementFwd,M=g.displacementBwd,B=l.shape,T=B[0],O=B[1],A=C(b,[i,d],[T,O],[[c.top,c.bottom],[c.left,c.right]]),L=C(v,[i,d],[T,O],[[c.top,c.bottom],[c.left,c.right]]),N=G(z(A),r);return{partSegmentation:he(N,L),heatmapScores:y,offsets:E,displacementFwd:R,displacementBwd:M}}),p=f.partSegmentation,h=f.heatmapScores,m=f.offsets,w=f.displacementFwd,S=f.displacementBwd;return l.dispose(),{partSegmentation:p,heatmapScores:h,offsets:m,displacementFwd:w,displacementBwd:S,padding:c,internalResolutionHeightAndWidth:u}},t.prototype.segmentPersonParts=function(n,e){return e===void 0&&(e=$),P(this,void 0,void 0,function(){var r,s,a,i,d,u,o,l,c,f,p,h,m,w,S,g,b,v;return F(this,function(y){switch(y.label){case 0:return e=I(I({},$),e),xt(e),r=this.segmentPersonPartsActivation(n,e.internalResolution,e.segmentationThreshold),s=r.partSegmentation,a=r.heatmapScores,i=r.offsets,d=r.displacementFwd,u=r.displacementBwd,o=r.padding,l=r.internalResolutionHeightAndWidth,c=s.shape,f=c[0],p=c[1],[4,s.data()];case 1:return h=y.sent(),s.dispose(),[4,J([a,i,d,u])];case 2:return m=y.sent(),w=m[0],S=m[1],g=m[2],b=m[3],v=Y(w,S,g,b,this.baseModel.outputStride,e.maxDetections,e.scoreThreshold,e.nmsRadius),v=Z(v,[f,p],l,o),a.dispose(),i.dispose(),d.dispose(),u.dispose(),[2,{height:f,width:p,data:h,allPoses:v}]}})})},t.prototype.segmentMultiPersonParts=function(n,e){return e===void 0&&(e=tt),P(this,void 0,void 0,function(){var r,s,a,i,d,u,o,l,c,f,p,h,m,w,S,g,b,v,y,E,R,M,B=this;return F(this,function(T){switch(T.label){case 0:return e=I(I({},tt),e),Ht(e),r=K(n),s=r[0],a=r[1],i=j(e.internalResolution,this.baseModel.outputStride,[s,a]),d=X(n,i),u=d.resized,o=d.padding,l=x(function(){var O=B.predictForMultiPersonInstanceSegmentationAndPart(u),A=O.segmentLogits,L=O.longOffsets,N=O.heatmapScores,D=O.offsets,_=O.displacementFwd,q=O.displacementBwd,W=O.partHeatmaps,st=C(A,[s,a],i,[[o.top,o.bottom],[o.left,o.right]]),Zt=C(W,[s,a],i,[[o.top,o.bottom],[o.left,o.right]]),$t=L,te=G(z(st),e.segmentationThreshold),ee=me(Zt);return{segmentation:te,longOffsets:$t,heatmapScoresRaw:N,offsetsRaw:D,displacementFwdRaw:_,displacementBwdRaw:q,partSegmentation:ee}}),c=l.segmentation,f=l.longOffsets,p=l.heatmapScoresRaw,h=l.offsetsRaw,m=l.displacementFwdRaw,w=l.displacementBwdRaw,S=l.partSegmentation,[4,J([p,h,m,w])];case 1:return g=T.sent(),b=g[0],v=g[1],y=g[2],E=g[3],R=Y(b,v,y,E,this.baseModel.outputStride,e.maxDetections,e.scoreThreshold,e.nmsRadius),R=Z(R,[s,a],i,o),[4,xe(c,f,S,R,s,a,this.baseModel.outputStride,i,o,e.scoreThreshold,e.refineSteps,e.minKeypointScore,e.maxDetections)];case 2:return M=T.sent(),u.dispose(),c.dispose(),f.dispose(),p.dispose(),h.dispose(),m.dispose(),w.dispose(),S.dispose(),[2,M]}})})},t.prototype.dispose=function(){this.baseModel.dispose()},t})();function Xe(t){return P(this,void 0,void 0,function(){var n,e,r,s,a,i;return F(this,function(d){switch(d.label){case 0:if(n=t.outputStride,e=t.quantBytes,r=t.multiplier,Pt==null)throw new Error(`Cannot find TensorFlow.js. If you are using a <script> tag, please also include @tensorflow/tfjs on the page before using this
