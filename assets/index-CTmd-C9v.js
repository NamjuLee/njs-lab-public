import{gF as x,gK as ct,gR as ne,gQ as ft,g_ as V,mf as nt,g$ as z,gT as It,mg as ut,gY as Pt,gE as Ft,mh as re,gL as ht,mi as ae,jX as Q,mj as At,mk as Lt,ml as Nt,gM as rt,gG as se,gH as oe,mm as ie,mn as de,mo as Dt,mp as ue,jV as le,gO as _t}from"./index-CXzFho1h.js";import{g as ce}from"./index-C0vqmb3-.js";import{R as fe}from"./RendererCanvas-ZMRkw2u7.js";import{l as Wt}from"./graph_model-C1rhbyNw.js";/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function Qt(t,n,e,r,s,a,i,d,u,o,l){for(var c=i[0],f=i[1],h=t.shape,p=h[0],m=h[1],w=n.shape.slice(0,2),S=w[0],g=w[1],b=rt(n,[S,g,2,H]),v=new Float32Array(l*H*3).fill(0),y=0;y<e.length;y++)for(var E=y*H*3,R=e[y],M=0;M<H;M++){var B=R.keypoints[M],T=E+M*3;v[T]=B.score,v[T+1]=B.position.y,v[T+2]=B.position.x}var O=pt([r,s],[c,f],d),A=O[0],L=O[1],N=ie(v,[l,H,3]),D=d.top,_=d.left,q={variableNames:["segmentation","longOffsets","poses"],outputShape:[p,m],userCode:`
