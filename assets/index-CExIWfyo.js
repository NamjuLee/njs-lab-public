import{gF as k,g_ as T,gE as q,gG as M,mt as I,gL as P,g$ as B,gY as L,mE as C,mF as j,mG as D}from"./index-B2mqmcVC.js";import{l as A}from"./graph_model-azmNHqv8.js";import{g as H}from"./index-C0vqmb3-.js";import{R}from"./RendererCanvas-ZMRkw2u7.js";import"./register_all_kernels-d9_gh0s3.js";/**
    * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function x(t,a){return""+K+"/"+(a===4?t+"/1/default/1/model.json":t+"/1/quantized/"+a+"/1/model.json")+"?tfjs-format=file"}function Y(t){if(t==="pascal")return S.PASCAL;if(t==="ade20k")return S.ADE20K;if(t==="cityscapes")return S.CITYSCAPES;throw new Error("SemanticSegmentation cannot be constructed with an invalid base model "+t+". Try one of 'pascal', 'cityscapes' and 'ade20k'.")}function F(t){if(t==="pascal")return E.PASCAL;if(t==="ade20k")return E.ADE20K;if(t==="cityscapes")return E.CITYSCAPES;throw new Error("SemanticSegmentation cannot be constructed with an invalid base model "+t+". Try one of 'pascal', 'cityscapes' and 'ade20k'.")}function G(t,a,r,i){return g(this,void 0,void 0,(function(){var n,l,o,s,d,c,e,u,p,b,f,m,y,h;return w(this,(function(v){switch(v.label){case 0:if(t.length<a.length)throw new Error("The colormap must be expansive enough to encode each label. Aborting, since the given colormap has length "+t.length+", but there are "+a.length+" labels.");return n=r.shape,l=n[0],o=n[1],s=D([l,o,3],"int32"),[4,r.array()];case 1:for(d=v.sent(),c=new Set,e=0;e<l;++e)for(u=0;u<o;++u)h=d[e][u],c.add(h),s.set(t[h][0],e,u,0),s.set(t[h][1],e,u,1),s.set(t[h][2],e,u,2);return p=s.toTensor(),[4,j(p,i)];case 2:for(b=v.sent(),C(p),f={},m=0,y=Array.from(c);m<y.length;m++)h=y[m],f[a[h]]=t[h];return[2,{legend:f,segmentationMap:b}]}}))}))}/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
