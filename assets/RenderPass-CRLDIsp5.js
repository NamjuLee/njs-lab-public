import"./three.module-Dsy4HPCo.js";import{dL as te,ae as D,bi as M,dM as U,ah as re,aA as V,d as se,am as ae,aj as oe,ak as z,ab as j,a$ as N,ba as ie,fy as le,bg as Z,cn as W,bc as L,C as K,V as Q,g9 as ce}from"./index-BhdSrBGh.js";class _e extends te{constructor(e){super(e),this.type=D}parse(e){const o=function(r,c){switch(r){case 1:throw new Error("THREE.HDRLoader: Read Error: "+(c||""));case 2:throw new Error("THREE.HDRLoader: Write Error: "+(c||""));case 3:throw new Error("THREE.HDRLoader: Bad File Format: "+(c||""));default:case 4:throw new Error("THREE.HDRLoader: Memory Error: "+(c||""))}},k=function(r,c,h){c=c||1024;let p=r.pos,f=-1,a=0,v="",n=String.fromCharCode.apply(null,new Uint16Array(r.subarray(p,p+128)));for(;0>(f=n.indexOf(`
