import"./index-DXWTkgC4.js";class i{static GetShader(e,t,a){let r=e.createShader(t);return e.shaderSource(r,a),e.compileShader(r),e.getShaderParameter(r,e.COMPILE_STATUS)?r:(e.deleteShader(r),null)}static CreateProgram(e,t,a,r=!0){const o=e.createProgram();return e.attachShader(o,t),e.attachShader(o,a),e.linkProgram(o),e.getProgramParameter(o,e.LINK_STATUS)?r&&(e.validateProgram(o),!e.getProgramParameter(o,e.VALIDATE_STATUS))?(console.error("Failed to validate program",e.getProgramInfoLog(o)),e.deleteProgram(o),e.deleteShader(a),e.deleteShader(t),null):(e.deleteShader(a),e.deleteShader(t),o):(e.getProgramInfoLog(o),e.deleteProgram(o),e.deleteShader(a),e.deleteShader(t),null)}static CreateShader(e,t,a){let r=e.createShader(t);return e.shaderSource(r,a),e.compileShader(r),e.getShaderParameter(r,e.COMPILE_STATUS)?r:(e.deleteShader(r),null)}static CreateShaderFromPath(e,t,a){let r=e.createShader(t);return e.shaderSource(r,i.GetSourceSynch(a)),e.compileShader(r),e.getShaderParameter(r,e.COMPILE_STATUS)?r:(e.deleteShader(r),null)}static GetSourceSynch(e){let t=new XMLHttpRequest;return t.open("GET",e,!1),t.send(null),t.status===200?t.responseText:null}static loadImage(e,t){let a=new Image;a.onload=function(){t(null,a)},a.src=e}}class u{constructor(e,t=100,a=100,r=0,o=1,c=1,s=1){this.v=`
...
//# sourceMappingURL=FilterGLViewDarkForDarken-tckAO_g_.js.map
