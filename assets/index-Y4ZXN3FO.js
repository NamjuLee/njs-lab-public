import"./register_all_kernels-sejC2z0T.js";import"./index-BpVWQNWp.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class st{constructor(n){this.apiKey=n}getGenerativeModel(n,e){if(!n.model)throw new f("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new nt(this.apiKey,n,e)}}class rt{constructor(n){this.divHost=document.getElementById(n);const e=document.createElement("div");e.style.padding="50px",this.divHost.appendChild(e),this.divInput=document.createElement("div"),this.divInput.textContent="Q: What is Computational Design?",this.divInput.style.color="#bbb",e.appendChild(this.divInput),this.divOut=document.createElement("div"),this.divOut.style.color="#777",e.appendChild(this.divOut),this.initGemini()}async initGemini(){const n="gemini-pro",e=new st("AIzaSyAC1CnqJgLitf9SkJpECyYT4-t7OqeL_hw");(async()=>{const s=e.getGenerativeModel({model:n}),o=this.divInput.textContent,a=(await(await s.generateContent(o)).response).text();this.divOut.textContent=a})()}destroy(){for(;this.divHost&&this.divHost.lastElementChild;){const n=this.divHost.lastElementChild;this.divHost.removeChild(n)}}}export{rt as Solution};
