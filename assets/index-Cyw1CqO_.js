import{gC as x,gH as ct,gO as ne,gN as ft,gX as V,mc as nt,gY as z,gQ as It,md as ut,gV as Pt,gB as Ft,me as re,gI as ht,mf as ae,jU as Q,mg as At,mh as Lt,mi as Nt,gJ as rt,gD as se,gE as oe,mj as ie,mk as de,ml as Dt,mm as ue,jS as le,gL as _t}from"./index-CD1L2QNH.js";import{g as ce}from"./index-C0vqmb3-.js";import{R as fe}from"./RendererCanvas-ZMRkw2u7.js";import{l as Wt}from"./graph_model-DcjSdbFq.js";/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function Se(t,n,e){e===void 0&&(e=.3);for(var r=0,s=0,a=0;a<t.length;a++)n.keypoints[a].score>e&&(s+=1,r+=Math.pow(t[a].x-n.keypoints[a].position.x,2)+Math.pow(t[a].y-n.keypoints[a].position.y,2));return s===0?r=1/0:r=r/s,r}function be(t,n,e,r){var s=n[0],a=n[1],i=e[0],d=e[1],u=Math.round(((s+t.y+1)*d-1)/r),o=Math.round(((a+t.x+1)*i-1)/r);return{x:o,y:u}}function Ee(t,n,e,r,s,a,i){for(var d=i[0],u=i[1],o=e(t),l=o.y*r+o.x,c=s[H*(2*l)+n],f=s[H*(2*l+1)+n],h=t.y+c,p=t.x+f,m=0;m<a;m++){h=Math.min(h,d-1),p=Math.min(p,u-1);var w=e({x:p,y:h}),S=w.y*r+w.x;c=s[H*(2*S)+n],f=s[H*(2*S+1)+n],h=h+c,p=p+f}return{x:p,y:h}}function Ut(t,n,e,r,s,a,i,d,u,o){for(var l=s[0],c=s[1],f=a[0],h=a[1],p=d[0],m=d[1],w=[],S=function(M){return be(M,[l,c],[f,h],u)},g=0;g<r;g++){var b=Ee(t,g,S,i,n,o,[p,m]);w.push(b)}for(var v=-1,y=1/0,E=0;E<e.length;E++){var R=Se(w,e[E]);R<y&&(v=E,y=R)}return v}function Kt(t,n){var e=t[0],r=t[1],s=Math.round((r-1)/n+1),a=Math.round((e-1)/n+1);return[s,a]}function Re(t,n,e,r,s,a,i,d,u,o){var l=i[0],c=i[1];o===void 0&&(o=5);for(var f=e.map(function(M){return new Uint8Array(r*s).fill(0)}),h=d.top,p=d.left,m=pt([r,s],[l,c],d),w=m[0],S=m[1],g=Kt([l,c],a)[0],b=0;b<r;b+=1)for(var v=0;v<s;v+=1){var y=b*s+v,E=t[y];if(E===1){var R=Ut({x:v,y:b},n,e,o,[h,p],[w,S],g,[r,s],a,u);R>=0&&(f[R][y]=1)}}return f}function Me(t,n,e,r,s,a,i,d,u,o,l){var c=d[0],f=d[1];l===void 0&&(l=5);for(var h=r.map(function(T){return new Int32Array(s*a).fill(-1)}),p=u.top,m=u.left,w=pt([s,a],[c,f],u),S=w[0],g=w[1],b=Kt([c,f],i)[0],v=0;v<s;v+=1)for(var y=0;y<a;y+=1){var E=v*a+y,R=t[E];if(R===1){var M=Ut({x:y,y:v},n,r,l,[p,m],[S,g],b,[s,a],i,o);M>=0&&(h[M][E]=e[E])}}return h}/**
 * @license
 * Copyright 2019 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
//# sourceMappingURL=index-Cyw1CqO_.js.map
